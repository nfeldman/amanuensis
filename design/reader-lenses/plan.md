...
| Packet | Title | Status | Depends on | Gate | Claims |
|---|---|---|---|---|---|
| P5 | Standing views and deterministic locus resolution | ready (1 attempt) | P1, P2 | `mcp-server/test-locus-index-view.mjs` | C4, C5, C6, C8, C9, C10, C11, C12, C13, C56, C57, C55, C63 |
