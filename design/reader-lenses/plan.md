...
| P20 | Regeneration pass: challenge outcomes before mapped, the missing edges, and the canonical project name | ready (1 attempt) | P18 | `dev/test-rebuild-regeneration.mjs` | C43, C52, C54, C55, C63 |
