...
## S1 · Truthful partition (review: pending)
...
| P4 | Ledger-derived freshness and a stale axis with a denominator | ready (1 attempt) | P1 | `materializer/test-ledger-freshness.py` | C50, C51, C60, C55, C63 |
