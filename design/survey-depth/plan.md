...
## S1 · Substrate obligations: existing stores, dispositions, reconciliation, vocabulary, carried findings (review: reviewed)
...
| P1 | Evidence-backed dispositions | done (1 attempt) | P0 | `mcp-server/test-disposition-evidence.mjs` | C7, C8, C9, C10, C32, C34, C37 |
| P2 | Scope reconciliation before authority | done (1 attempt) | P1 | `mcp-server/test-scope-reconciliation.mjs` | C11, C12, C13, C34, C38 |
...
| Packet | Title | Status | Depends on | Gate | Claims |
|---|---|---|---|---|---|
| P5 | The depth gate and its frozen baseline | done (2 attempts) | P1, P2, P3, P4 | `dev/test-survey-depth-red-gates.mjs` | C1, C2, C3, C4, C5, C6, C28, C29, C34, C36, C42 |
| P6 | The projection renders 'not measured' | done (1 attempt) | P2, P3, P4 | `materializer/test-unmeasured-coverage.py` | C14, C18, C34, C39 |

## S3 · Skill parity and its check (review: reviewed)

| Packet | Title | Status | Depends on | Gate | Claims |
|---|---|---|---|---|---|
| P7 | Skill parity and the refusal-parity check | done (1 attempt) | P1, P2, P3, P4 | `mcp-server/test-refusal-parity.mjs` | C26, C27, C34 |

## S4 · Acceptance rebuild and the Pecia reconciliation of the carried findings (review: reviewed)

| Packet | Title | Status | Depends on | Gate | Claims |
|---|---|---|---|---|---|
| P8 | Reinitialize, carry, and onboard in the lane worktree | done (1 attempt) | P5, P6, P7 | `dev/test-carry-receipt.mjs` | C25, C30, C34, C41, C42 |
| P10 | Survey every subsystem and decide every carried finding | done (1 attempt) | P8 | `dev/test-survey-depth.mjs` | C34, C41, C42 |
| P11 | Publish, promote, and record the acceptance receipts | done (1 attempt) | P10 | `dev/test-survey-depth-acceptance.mjs` | C31, C33, C34 |
| P9 | Pecia reconciliation of the carried findings | done (1 attempt) | P11 | `dev/test-pecia-carry-audit.mjs` | C24, C25, C34 |
