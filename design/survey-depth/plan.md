...
## S1 · Substrate obligations: dispositions, reconciliation, vocabulary, carried findings (review: pending)

| Packet | Title | Status | Depends on | Gate | Claims |
|---|---|---|---|---|---|
| P1 | Evidence-backed dispositions | ready | — | `mcp-server/test-disposition-evidence.mjs` | C7, C8, C9, C10, C32 |
| P2 | Scope reconciliation before authority | ready | — | `mcp-server/test-scope-reconciliation.mjs` | C11, C12, C13 |
| P3 | Vocabulary: discharge or decline | ready | — | `mcp-server/test-vocabulary-discharge.mjs` | C15, C16, C17 |
| P4 | Findings carry forward across a reinitialization | ready | — | `mcp-server/test-carried-findings.mjs` | C19, C20, C21, C22, C23, C24 |

## S2 · The depth gate and the projection's 'not measured' rendering (review: pending)

| Packet | Title | Status | Depends on | Gate | Claims |
|---|---|---|---|---|---|
| P5 | The depth gate and its frozen baseline | ready | P1, P2, P3, P4 | `dev/test-survey-depth-red-gates.mjs` | C1, C2, C3, C4, C5, C6, C28, C29 |
| P6 | The projection renders 'not measured' | ready | P2, P3 | `materializer/test-unmeasured-coverage.py` | C14, C18 |

## S3 · Skill parity and its check (review: pending)

| Packet | Title | Status | Depends on | Gate | Claims |
|---|---|---|---|---|---|
| P7 | Skill parity and the refusal-parity check | ready | P1, P2, P3, P4 | `mcp-server/test-refusal-parity.mjs` | C26, C27 |

## S4 · Acceptance rebuild and the Pecia reconciliation of the carried findings (review: pending)

| Packet | Title | Status | Depends on | Gate | Claims |
|---|---|---|---|---|---|
| P8 | Acceptance rebuild in the lane worktree | ready | P5, P6, P7 | `dev/test-survey-depth-acceptance.mjs` | C25, C30, C31, C33 |
| P9 | Pecia reconciliation of the carried findings | ready | P8 | `dev/test-carried-finding-references.mjs` | C24, C25 |
